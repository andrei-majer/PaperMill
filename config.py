...
def _reload_settings() -> None:
    ...
    global LLM_PROVIDER, ANTHROPIC_API_KEY, OPENAI_API_KEY, OPENROUTER_API_KEY
    _user_settings = _load_settings()
    ...
    LLM_PROVIDER = _user_settings.get("llm_provider", os.environ.get("LLM_PROVIDER", "ollama"))
...
# ── LLM Provider ─────────────────────────────────────────────────────────
# "ollama", "lmstudio", "claude", "openai", or "openrouter"
LLM_PROVIDER = _user_settings.get("llm_provider", os.environ.get("LLM_PROVIDER", "ollama"))
